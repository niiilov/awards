...
export const RolesModal: React.FC<OrderModalProps> = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl p-6 w-full max-w-[450px] shadow-lg relative animate-in fade-in zoom-in">
        ...
        <h2 className="text-2xl font-semibold mb-4">Добавить роль</h2>

        <div className="space-y-2 mb-6 overflow-y-auto">
          <div className="grid w-full max-w-sm items-center gap-3">
            <Label>Роль в комиссии</Label>
            <Input type="text" placeholder="Введите роль в комиссии" />
          </div>
